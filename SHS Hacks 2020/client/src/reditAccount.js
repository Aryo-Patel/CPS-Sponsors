...
document.querySelector('#rusername').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))
document.querySelector('#rname').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['name']
document.querySelector('#rpassword').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['password']
document.querySelector('#remail').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['email']
document.querySelector('#rphonenumber').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['phonenumber']
document.querySelector('#rstreet').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['street'];
document.querySelector('#rschool').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['school'];
document.querySelector('#rtwoaddress').value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['twoaddress'];
biography.value = JSON.parse(localStorage.getItem(localStorage.getItem("currentUser")))['biography']
...
Array.from(donationSelect).forEach(dropdowns => {
    dropdowns.addEventListener('click', function (event) {
        ...
        let p = document.createTextNode('Delete');
        let men = document.createElement('DIV')
        u.setAttribute("class", "delete")
        men.setAttribute('class', 'randDiv')
        u.appendChild(p)
        r.appendChild(n)
...
Array.from(deletes).forEach(element => {
    element.addEventListener('click', function(event) {
        event.parentNode.parentNode.removeChild(event.parentNode.id)
    })
})
